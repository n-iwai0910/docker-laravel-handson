...
var container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.editor').get(0);
var editor = new (quill__WEBPACK_IMPORTED_MODULE_4___default())(container);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image2').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview2").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image3').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview3").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image4').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview4").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image5').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview5").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image6').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview6").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image7').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview7").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image8').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview8").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image9').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview9").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image10').on('change', function (e) {
  var reader = new FileReader();

  reader.onload = function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#preview10").attr('src', e.target.result);
  };

  reader.readAsDataURL(e.target.files[0]);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumb-item').slick({
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumb-item-nav').slick({
    accessibility: true,
    autoplay: false,
    autoplaySpeed: 4000,
    speed: 400,
...
(quill__WEBPACK_IMPORTED_MODULE_4___default().prototype.getHtml) = function () {
  return this.container.querySelector('.ql-editor').innerHTML;
};

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-quill-editor').each(function (index, e) {
    var $target = jquery__WEBPACK_IMPORTED_MODULE_0___default()(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).data('target'));
    var editor = new (quill__WEBPACK_IMPORTED_MODULE_4___default())(e, {
      modules: {
